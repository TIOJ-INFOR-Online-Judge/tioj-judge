...
const std::string kVersionCode = "2.1.0";
...
void SendResult(const Submission&, const SubmissionResult&, int subtask);
void SendFinalResult(const Submission&, const SubmissionResult&);
